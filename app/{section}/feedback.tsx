...
function Box() {
  return (
    <div className='bg-gray-dark-1 border-2  border-green-1 p-8 md:p-16 rounded-lg text-center space-y-3'>
      <div className='flex flex-col md:flex-row items-center justify-center gap-y-3 gap-x-3'>
        ...
        <div>
          <h4 className='text-green-1 underline font-bold md:text-3xl'>
            Noor Muhammad
          </h4>
          <p className='font-thin md:text-xl'>Software Engineer</p>
        </div>
      </div>
      <p className='font-thin md:text-lg w-1/2 mx-auto'>
